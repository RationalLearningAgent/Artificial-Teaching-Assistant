			...
			if(choice1==1):
				...
				while(choice1a!=6):
					...
					if(choice1a==1):
						...
						call(["python","Thresholding_Grayscale.py"])

					elif(choice1a==3):

						call(["python","Intensity_Level_Slicing_Without_Background_Grayscale.py"])

					elif(choice1a==4):

						call(["python","Intensity_Level_Slicing_With_Background_Grayscale.py"])
			
					elif(choice1a==5):

						call(["python","Bit_Plane_Slicing_Grayscale.py"])
				...
				while(choice1b!=3):
					...
					if(choice1b==1):
						...
						call(["python","Text_Colour_RGB.py"])
			...
			if(choice3==1):
				...
				while(choice3a!=7):
					...
					if(choice3a==1):
						...
						call(["python","Image_Smoothing_3x3_Grayscale.py"])

					elif(choice3a==2):

						call(["python","Image_Smoothing_5x5_Grayscale.py"])

					elif(choice3a==3):

						call(["python","Image_Sharpening_No_Diagonal_Elements_Grayscale.py"])

					elif(choice3a==4):

						call(["python","Image_Sharpening_Diagonal_Elements_Grayscale.py"])

					elif(choice3a==5):

						call(["python","Median_Filter_3x3_Grayscale.py"])

					elif(choice3a==6):

						call(["python","Median_Filter_5x5_Grayscale.py"])
				...
				while(choice3b!=7):
					...
					if(choice3b==1):
						...
						call(["python","Image_Smoothing_3x3_RGB.py"])

					elif(choice3b==2):
			
						call(["python","Image_Smoothing_5x5_RGB.py"])

					elif(choice3b==3):
		
						call(["python","Image_Sharpening_No_Diagonal_Elements_RGB.py"])

					elif(choice3b==4):

						call(["python","Image_Sharpening_Diagonal_Elements_RGB.py"])

					elif(choice3b==5):

						call(["python","Median_Filter_3x3_RGB.py"])

					elif(choice3b==6):

						call(["python","Median_Filter_5x5_RGB.py"])
