...
The task of a factoid question answering system is thus to answer questions by finding from the given article or document, short text segments that are likely to contain answers to questions, reformatting them, and presenting them to the user.
...
3) Answer processing''')
	...
	self.Button1.configure(command=lambda: call(["python","Question_Answering_System/Question_Answering_System_main.py"]))
